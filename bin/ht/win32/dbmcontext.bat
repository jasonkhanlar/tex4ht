...
Rem 
Rem 
Rem   dbmcontext.bat                                  Version 1.1
...
Rem 
        ...
        tex4ht %1 -ic:/tex4ht/texmf/tex4ht/ht-fonts/%3 -ec:/tex4ht/texmf/tex4ht/base/win32/tex4ht.env -cunihtf
        t4ht %1 %4 -ec:/tex4ht/texmf/tex4ht/base/win32/tex4ht.env -cvalidate -cdocbk 
