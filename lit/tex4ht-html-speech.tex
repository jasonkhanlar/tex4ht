% $Id: tex4ht-html-speech.tex 137 2015-01-28 22:55:44Z karl $
...
\<russian\><<<
\Configure{accent}\"\ddot{|<diaeresis codes|>ו{00EB}%
           ...
           {\@use@text@encoding \@curr@enc ו}{00EB}%
           {}{34}}
   {\a:accents{uml}{#1}}    
...
\begin{document}
פיסקה בעברית
 \[F=ma\quad(\textrm{\L{Newton's 2nd Law}\R{בעברית }})\]
 \[F=ma\quad(\mbox{Newton's 2nd Law בעברית} )\]
 \R{\[F=ma\quad(\mbox{Newton's 2nd Law בעברית} )\]}
ועוד קצת עברית
\end{document}
