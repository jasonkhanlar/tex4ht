...
% Bitouzé <dbitouze@wanadoo.fr>. A thorough revamping was needed to
...
Old url.sty filesemploy \''\Url@use', new ones employ \''Url@Left'.
...
> a hyphen between them, e.g. "Select-Klausel" or "depends-Abhängigkeit", 
...
> Select-""Klausel, depends-""Abh"angigkeit ("a is short for \"{a} = ä).
