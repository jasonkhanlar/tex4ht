...
#ifndef KPATHSEA
#ifdef PLATFORM
   (IGNORED) printf("t4ht.c (Version 1.1 %s)\n",PLATFORM);
#else
   (IGNORED) printf("t4ht.c (Version 1.1)\n");
#endif
#else
#ifdef PLATFORM
   (IGNORED) printf("t4ht.c (Version 1.1 %s kpathsea)\n",PLATFORM);
#else
   (IGNORED) printf("t4ht.c (Version 1.1 kpathsea)\n");
#endif
#endif
